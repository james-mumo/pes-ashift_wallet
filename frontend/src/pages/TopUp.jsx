            ...
            <div className="flex p-10 flex-col ">
              ...
              {!transactions.length ? (
                <div className="flex flex-col gap-5 pt-20 justify-center items-center">
                  ...
                  <button className="bg-yellow-700 text-white px-6 py-3 rounded-md shadow-md hover:bg-yellow-600 transition-colors duration-300">
                    Add Now
                  </button>
                </div>
              ) : (
